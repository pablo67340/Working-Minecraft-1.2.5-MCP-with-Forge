...
public class EntityAIOwnerHurtByTarget extends EntityAITarget {
   ...
   public EntityAIOwnerHurtByTarget(EntityTameable p_i1088_1_) {
      super(p_i1088_1_, 32.0F, false);
      this.field_48394_a = p_i1088_1_;
      this.func_46079_a(1);
   }

   public boolean func_46082_a() {
      if(!this.field_48394_a.func_48139_F_()) {
         return false;
      } else {
         EntityLiving var1 = this.field_48394_a.func_48144_ah();
         if(var1 == null) {
            return false;
         } else {
            this.field_48393_b = var1.func_46007_aL();
