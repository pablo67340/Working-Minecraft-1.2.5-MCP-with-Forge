...
public abstract class Minecraft implements Runnable
{
    ...
    private void displayDebugInfo(long par1)
    {
        ...
        this.fontRenderer.drawStringWithShadow(var30 = var28.format(var4.globalPercentage) + "%", var15 + var26 - this.fontRenderer.getStringWidth(var30), var16 - var26 / 2 - 16, var21);
        ...
        for (int var32 = 0; var32 < var3.size(); ++var32)
        {
            ...
            this.fontRenderer.drawStringWithShadow(var33 = var28.format(var31.sectionPercentage) + "%", var15 + var26 - 50 - this.fontRenderer.getStringWidth(var33), var16 + var26 / 2 + var32 * 8 + 20, var31.getDisplayColor());
            this.fontRenderer.drawStringWithShadow(var33 = var28.format(var31.globalPercentage) + "%", var15 + var26 - this.fontRenderer.getStringWidth(var33), var16 + var26 / 2 + var32 * 8 + 20, var31.getDisplayColor());
        }
    }
