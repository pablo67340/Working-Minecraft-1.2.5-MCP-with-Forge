...
public class RenderPlayer extends RenderLiving
{
    ...
    protected void renderSpecials(EntityPlayer par1EntityPlayer, float par2)
    {
        ...
        if (this.loadDownloadableImageTexture(par1EntityPlayer.playerCloakUrl, (String)null))
        {
            ...
            double var20 = par1EntityPlayer.field_20066_r + (par1EntityPlayer.field_20063_u - par1EntityPlayer.field_20066_r) * (double)par2 - (par1EntityPlayer.prevPosX + (par1EntityPlayer.posX - par1EntityPlayer.prevPosX) * (double)par2);
