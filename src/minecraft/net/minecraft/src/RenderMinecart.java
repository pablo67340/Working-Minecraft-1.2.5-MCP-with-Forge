...
public class RenderMinecart extends Render
{
    ...
    public void func_152_a(EntityMinecart par1EntityMinecart, double par2, double par4, double par6, float par8, float par9)
    {
        ...
        float var29 = (float)par1EntityMinecart.func_41025_i() - par9;
        ...
        if (var28 > 0.0F)
        {
            GL11.glRotatef(MathHelper.sin(var28) * var28 * var29 / 10.0F * (float)par1EntityMinecart.func_41030_m(), 1.0F, 0.0F, 0.0F);
        }
