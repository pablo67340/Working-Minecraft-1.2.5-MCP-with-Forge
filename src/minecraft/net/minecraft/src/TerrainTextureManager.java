                                ...
                                else
                                {
                                    ...
                                    if (var15 >= 0 && var15 < 544)
                                    {
                                        ...
                                        if (var12 >= 0 && this.zBuf[var25] <= var14)
                                        {
                                            ...
                                            this.pixels[var25] = -16777216 | (int)(this.texCols[var26 * 3 + 0] * var27) << 16 | (int)(this.texCols[var26 * 3 + 1] * var27) << 8 | (int)(this.texCols[var26 * 3 + 2] * var27);
                                        }
                                        ...
                                        if (var12 < 31)
                                        {
                                            ...
                                            if (this.zBuf[var25 + 1] <= var14)
                                            {
                                                ...
                                                this.pixels[var25 + 1] = -16777216 | (int)(this.texCols[var26 * 3 + 0] * var22) << 16 | (int)(this.texCols[var26 * 3 + 1] * var22) << 8 | (int)(this.texCols[var26 * 3 + 2] * var22);
                                            }
                                        }
                                    }
                                    ...
                                    if (var15 >= -1 && var15 < 543)
                                    {
                                        ...
                                        if (var12 >= 0)
                                        {
                                            ...
                                            if (this.zBuf[var25] <= var14 - 1)
                                            {
                                                ...
                                                this.pixels[var25] = -16777216 | (int)(this.texCols[var26 * 3 + 0] * var23) << 16 | (int)(this.texCols[var26 * 3 + 1] * var23) << 8 | (int)(this.texCols[var26 * 3 + 2] * var23);
                                            }
                                        }
                                        ...
                                        if (var12 < 31)
                                        {
                                            ...
                                            if (this.zBuf[var25 + 1] <= var14 - 1)
                                            {
                                                ...
                                                this.pixels[var25 + 1] = -16777216 | (int)(this.texCols[var21 * 3 + 0] * var23) << 16 | (int)(this.texCols[var21 * 3 + 1] * var23) << 8 | (int)(this.texCols[var21 * 3 + 2] * var23);
                                            }
                                        }
                                    }
                                }
