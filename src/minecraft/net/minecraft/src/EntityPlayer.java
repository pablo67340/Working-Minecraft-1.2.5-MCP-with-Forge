...
public abstract class EntityPlayer extends EntityLiving
{
    ...
    {
        FMLCommonHandler.instance().tickStart(EnumSet.of(TickType.PLAYER), this, this.worldObj);
        if (this.itemInUse != null)
        {
        ...
        FMLCommonHandler.instance().tickEnd(EnumSet.of(TickType.PLAYER), this, this.worldObj);
    }
