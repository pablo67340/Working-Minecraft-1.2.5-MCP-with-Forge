...
public class FMLClientHandler implements IFMLSidedHandler
{
    ...
    {
        client.onMinecraftCrash(new UnexpectedThrowable(message, t));
    }
    /**
    ...
    public void onPreWorldTick()
    {
        if (client.theWorld != null) {
            ...
            FMLCommonHandler.instance().tickStart(EnumSet.of(TickType.WORLD), client.theWorld, client.currentScreen, client.theWorld);
            FMLCommonHandler.instance().tickStart(EnumSet.of(TickType.GAME,TickType.WORLDGUI), 0.0f, client.currentScreen, client.theWorld);
        }
    }
    ...
    public void onPostWorldTick()
    {
        if (client.theWorld != null) {
            // For the client world ticks and game ticks are the same
            FMLCommonHandler.instance().tickEnd(EnumSet.of(TickType.WORLD), client.theWorld, client.currentScreen, client.theWorld);
            FMLCommonHandler.instance().tickEnd(EnumSet.of(TickType.GAME,TickType.WORLDGUI), 0.0f, client.currentScreen, client.theWorld);
        }
    ...
    {
        FMLCommonHandler.instance().tickStart(EnumSet.of(TickType.RENDER,TickType.GUI), partialTickTime, client.currentScreen);
    }
    ...
    public void onRenderTickEnd(float partialTickTime)
    {
        if (!guiLoaded)
        {
            ...
            FMLCommonHandler.instance().tickStart(EnumSet.of(TickType.GUILOAD), partialTickTime, client.currentScreen);
            guiLoaded = true;
        }
        FMLCommonHandler.instance().tickEnd(EnumSet.of(TickType.RENDER,TickType.GUI), partialTickTime, client.currentScreen);
    }
    /**
